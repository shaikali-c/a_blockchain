...
void test_tx_roundtrip() {
    ...
    Transaction original{std::move(ins), std::move(outs), 123456789};
...
void test_block_roundtrip() {
    ...
    Transaction coinbase{{}, {{addr, 99}}, 123456789};
    Block original{ph, {std::move(coinbase)}, 123456789, 9};
...
void test_coinbase() {
    Address addr{};
    addr.fill(0xaa);
    Transaction coinbase{{}, {{addr, 100}}, 0};
